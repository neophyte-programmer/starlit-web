...
import { DELETE_ENQUIRY } from "@/utils/server/enquiry"


export default function DeleteEnquiryDialog({ data }: { data: Enquiry; }) {
    ...
    const deletePosition = useMutation({
        mutationFn: () => {
            ...
            return DELETE_ENQUIRY(data._id, user.token)
        },
    ...
    return (
        <>
            <DialogHeader>
                <DialogTitle className="poppins">Delete Enquiry</DialogTitle>
                <DialogDescription>
                    Confirm that you want to delete this enquiry permanently.
                </DialogDescription>
            </DialogHeader>
