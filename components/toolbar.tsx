...
export default function Toolbar({ editor }: Props) {
    return (
        <div className="flex flex-wrap gap-4">
            ...
            <ActionTooltip label="Bullet List">
                <button
                    type="button"
            ...
            <ActionTooltip label="Numbered List">
                <button
                    type="button"
            ...
            <ActionTooltip label="Code Block">
                <button
                    type="button"
